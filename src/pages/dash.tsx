        ...
        <div className='flex flex-row gap-5 text-white'>
            <div className='flex flex-col flex-1 bg-white/5 rounded-md p-5 gap-2'>
                <div className='flex flex-row gap-10'>
                    ...
                    <h1 className='flex text-2xl font-bold'>{pageData.symbol.toUpperCase()} / USDT</h1>
                </div>
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        <div className='flex flex-row gap-5'>
                            {pageData.payload_source.symbols.map((symbol, index) => {
                                return <h1 key={index} className='flex text-2xl font-bold'>{symbol} / USDT : {pageData.payload_blog?.price[index]} </h1>
                            })}
                        </div>
                        : null
                        }
            ...
            <div className='flex flex-col bg-white/5 rounded-md p-5 gap-5'>
                <div className='flex flex-row text-4xl font-bold gap-5'>
                    <button className="bg-green-500 hover:bg-green-400 rounded-md w-28 aspect-square">5k</button>
                    <button className="bg-green-500 hover:bg-green-400 rounded-md w-28 aspect-square">20k</button>
                    <button className="bg-green-500 hover:bg-green-400 rounded-md w-28 aspect-square">120k</button>
                    <button className="bg-red-500   hover:bg-red-400   rounded-md w-28 aspect-square">5k</button>
                    <button className="bg-red-500   hover:bg-red-400   rounded-md w-28 aspect-square">20k</button>
                    <button className="bg-red-500   hover:bg-red-400   rounded-md w-28 aspect-square">120k</button>
                </div>
                <div className='h-0.5 bg-white rounded-full'/>
                <div className='flex flex-row text-4xl font-bold gap-5 '>
                    <button 
                    ...
                    <input className="flex-1 bg-transparent hover:bg-white/5 min-w-0 outline outline-2 justify-right rounded-md px-5 text-right" size={1}/>
                    <button className="flex bg-green-500 hover:bg-green-400 rounded-md py-2 px-10">Buy</button>
                    <button className="flex bg-red-500   hover:bg-red-400   rounded-md py-2 px-10">Sell</button>
                </div>
